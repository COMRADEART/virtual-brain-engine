...
// Pure splitter: turns "[m:<id>] markers into ordered text/cite parts. Exported
// so the citation-rendering contract ([m:id] → chip, unknown ids still emitted,
// trailing/leading text preserved) has a runnable check without DOM rendering.
// ponytail: the ceiling is a single left-to-right regex scan — no nesting, no
// escaped brackets; markers never appear inside memory text today.
